...
void resolve(int idx) {
    v[idx].se.se = v[idx + v[idx].se.fi].se.se+1;
}
...
void solve(){
    ...
    ffor(i,1,n/2) {
        if (v[idx+1].se.se == v[idx+2].se.se) {
            athrow(idx-1);
            int res; cin >> res;
            v[idx-1].se.fi = (res == v[idx+1].se.se+1) ? 2 : 1;
            aswap(idx-1); swap(v[idx], v[idx-1]);
            athrow(idx-1);
            cin >> res;
            v[idx-1].se.fi = (res == v[idx+1].se.se+1) ? 2 : 1;
            ...
            athrow(idx);
            int res; cin >> res;
            v[idx].se.fi = (res == v[idx+1].se.se+1) ? 1 : 2;
            aswap(idx-1); swap(v[idx], v[idx-1]);
            athrow(idx);
            cin >> res;
            v[idx].se.fi = (res == v[idx+1].se.se+1) ? 1 : 2;
